      ...
      <section data-nav-theme="dark" className="relative isolate overflow-hidden bg-primary py-24 sm:py-28 text-cream">
        <Spotlight>
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            />
            <p className="mt-5 max-w-2xl text-lg font-light text-cream/75">{category.description}</p>
          </div>
        </Spotlight>
      </section>
              ...
              <TiltCard key={s.slug} intensity={6} className="h-full">
                <CardSpotlight className="h-full">
                  <Link
                    ...
                    className="group flex h-full flex-col justify-between border-2 border-primary/25 bg-cream p-6 shadow-[4px_4px_0_0_#093FB4] transition-colors duration-200 hover:border-primary/40"
                  >
                    <div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-3">
            <div className="lg:col-span-2">
              <div className="border-2 border-primary/10 bg-cream p-8 md:p-10">
